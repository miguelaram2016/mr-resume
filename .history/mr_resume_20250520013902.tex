...
\begin{itemize}[leftmargin=0.15in]
  \item[]
    ...
    \begin{itemize}[leftmargin=0.15in]
      \item GPA: 3.4/4.0
      \item Relevant Coursework: Data Structures, Algorithms, Database Systems, Web Development, Machine Learning
      \item Honors: Dean's List (Fall 2018, Spring 2019, Fall 2020)
      \item Activities: HackTX 2020, HackTX 2021, Hackathon Mentor
      \item Extracurricular: HackTX, Hackathon Mentor
  \item[]
